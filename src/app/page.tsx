...
export default function Home() {
  ...
  const renderWelcomeScreen = () => (
    <div className="w-full max-w-sm mx-auto bg-card/80 backdrop-blur-sm rounded-2xl shadow-xl p-6 flex flex-col animate-in fade-in-50 duration-500 h-[95vh] min-h-[700px]">
