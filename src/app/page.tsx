...
export default function Home() {
  ...
  const renderWelcomeScreen = () => (
    <div className="w-full max-w-sm mx-auto bg-gradient-to-br from-purple-400 to-purple-500 text-primary-foreground rounded-2xl shadow-xl p-6 flex flex-col animate-in fade-in-50 duration-500 h-[95vh] min-h-[700px] bg-[length:200%_200%] animate-gradient-shift">
