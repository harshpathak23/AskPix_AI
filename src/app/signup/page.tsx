          ...
          <form className="space-y-4">
             <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input id="name" placeholder="John Doe" required className="pl-10 bg-white/90 text-slate-900 placeholder:text-slate-500 border-transparent focus:bg-white focus:border-purple-500 focus:ring-purple-500" />
              </div>
            </div>
            <div className="space-y-2">
